...
#### Terraform Backend
 ...
 - Terraform remote backend cannot be configured    directly on the first run if the resources are not available already. 

    Two ways to configure the Terraform remote Backend
